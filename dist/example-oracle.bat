...
ECHO.
java -jar dbQueryExport.jar -c oracle.jdbc.driver.OracleDriver -d jdbc:oracle:thin:@localhost:1521:XE -u MYUSER -p MYUSER

ECHO.
ECHO Example #4: Loading Oracle Driver and define databse url, username and password and define SqlFileName complete path ...
ECHO.
java -jar dbQueryExport.jar -c oracle.jdbc.driver.OracleDriver -d jdbc:oracle:thin:@localhost:1521:XE -u MYUSER -p MYUSER -f .\example-oracle-query-1.sql
...
ECHO.
java -jar dbQueryExport.jar -c oracle.jdbc.driver.OracleDriver -d jdbc:oracle:thin:@localhost:1521:XE -u MYUSER -p MYUSER -f .\example-oracle-query-1.sql -o .\example-oracle-query-1.xls
...
ECHO.
java -jar dbQueryExport.jar -c oracle.jdbc.driver.OracleDriver -d jdbc:oracle:thin:@localhost:1521:XE -u MYUSER -p MYUSER -f .\example-oracle-query-2.sql -o .\example-oracle-query-2.xls
